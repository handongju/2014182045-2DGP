...
def move_circle_10_points(p1, p2, p3, p4):
    # draw p1-p2
    for i in range(0, 50, 2):
        t = i / 100
        x = (7*t**7-9*t+8)*p1[0]+(-10*t**2+4*t)*p2[0]+(2*t**2-t)*p3[0]
        y = (7*t**7-9*t+8)*p1[1]+(-10*t**2+4*t)*p2[1]+(2*t**2-t)*p3[1]
        draw_point((x, y))
    draw_point(p2)
